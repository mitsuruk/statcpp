 ...
 * - tukey_hsd(): Tukey HSD method (post-hoc comparison)
 ...
 *
 * [Purpose]
 * Tukey HSD (Honestly Significant Difference) method is a post-hoc
 ...
 * - Optimal for equal sample sizes
 * - Strict control of Type I error rate
 *
 * [Notes]
 * - Only perform when ANOVA is significant
 * - Tests all possible pairwise comparisons
 * - Conservative test (lower power)
 */
void example_tukey_hsd()
{
    print_section("tukey_hsd() - Tukey HSD Method (Post-hoc Comparison)");
