...
statcpp is a header-only statistics library written in C++17. It provides a wide range of statistical functions, from basic statistics to advanced hypothesis testing and regression analysis.
