...
/**
 * @brief Weighted median (safe overload)
 *
...
double weighted_median(Iterator first, Iterator last, WeightIterator weight_first, WeightIterator weight_last)
{
    ...
    for (std::size_t i = 0; i < pairs.size(); ++i) {
        ...
        if (cumulative >= half_weight) {
            // If cumulative weight is (approximately) exactly half, take average with next positive-weight value
...
/**
 * @brief Weighted median with projection (safe overload)
 *
 * Calculates the weighted median with range safety validation.
 *
 * @tparam Iterator Iterator type
...
/**
 * @brief Weighted percentile (safe overload)
 *
...
/**
 * @brief Weighted percentile with projection (safe overload)
 *
 * Calculates the weighted percentile with range safety validation.
 *
 * @tparam Iterator Iterator type
