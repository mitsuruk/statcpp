...
/**
 * @brief Validate 2D matrix structure (all rows have same column count, not empty)
 *
 * @param data Matrix data to validate
 * @param func_name Calling function name (for error messages)
