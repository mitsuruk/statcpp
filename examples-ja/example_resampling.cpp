...
int main()
{
    ...
    std::cout << "中央値（Median）は外れ値に対してロバストな統計量です。\n";
    ...
    std::cout << "中央値:            " << original_median << " 時間（ロバスト）\n\n";
    ...
    std::cout << "=============================================================\n";
    std::cout << "5. 置換検定（Permutation Test）- 基本概念\n";
    std::cout << "=============================================================\n\n";
    ...
    std::cout << "  ...\n\n";
    std::cout << "これらの置換で生成された差の分布と、観測差を比較し\n";
    std::cout << "p値を計算します。\n\n";

    std::cout << "=============================================================\n";
    std::cout << "6. 置換検定 - 2群の平均差の検定\n";
    std::cout << "=============================================================\n\n";
    ...
    std::cout << "中央値の信頼区間を求めたい（外れ値に対してロバスト）:\n";
    ...
    std::cout << "  → リサンプリング法（Bootstrap、置換検定）を使用\n";
